...
\newcommand{\whitenode}{node[circle,inner sep=2pt]} 					%gamma 7
\newcommand{\rectanglenode}{node[rectangle,inner sep=2.5pt]} 				%gamma 8
\newcommand{\threenode}{node[regular polygon,regular polygon sides=3,inner sep=1.5pt]}	%gamma 9
